...
This is an unofficial fan-made theme. It is not affiliated with or endorsed by
OpenAI, the Monogatari production committee, Kodansha, Aniplex, SHAFT, or the
authors and rightsholders of the referenced works.

The MIT License covers the software in this repository. It does not grant any
...
select another image they are personally entitled to use.
Imported images remain on that user's machine and are never uploaded by this
tweak.
